    ...
    return (
        <div className="hero mt-10 h-fit p-10 bg-blue-300">
            <div className="hero-content flex-col lg:flex-row-reverse  rounded-lg ">
                ...
                <div  data-aos="fade-down-right" className="w-1/2 shadow-2xl p-10 rounded-lg bg-gradient-to-r from-blue-300 to-blue-500 ... font-serif text-black ">
                    
                    <h2 className="text-4xl font-extrabold p-5 text-center text-green-800">How we care </h2>
                    <h4 className="text-xl font-bold text-green-700">Certified practitioner</h4>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus, consequuntur.</p>
                    <h4 className="text-xl font-bold text-green-700 ">Modern technology</h4>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus, consequuntur.</p>
                    <h4  className="text-xl font-bold text-green-700 ">House Call Service</h4>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus, consequuntur.</p>
                    <h4  className="text-xl font-bold text-green-700">Membership / Year</h4>
